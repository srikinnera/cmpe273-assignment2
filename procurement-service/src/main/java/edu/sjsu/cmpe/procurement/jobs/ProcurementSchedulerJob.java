...
public class ProcurementSchedulerJob extends Job {
    ...
    public void doJob() throws Exception{
    		String input="{\"id\":\"32304\",\"order_book_isbns\" : [" ;
		String input1;
		...
		ClientResponse response=ProcurementService.jerseyClient.create().resource(
				"http://54.215.133.131:9000/orders").type("application/json").post(ClientResponse.class,input1);
		...
		ClientResponse serverResponse=ProcurementService.jerseyClient.create().resource(
				"http://54.215.133.131:9000/orders/32304").accept("application/json").get(ClientResponse.class);
